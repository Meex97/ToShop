    ...
    this.auth2.attachClickHandler(this.loginElement.nativeElement, {},
      (googleUser) => {
        ...
        this.userService.getClient(profile.getEmail()).subscribe( u => {
          //console.log('Cripted Pass using crypto.getRandomValues(): ' + crypto.getRandomValues(profile.getEmail()));
          //this.fillLoginFields(u.email, crypto.getRandomValues(profile.getEmail()));
          this.fillLoginFields(u.email, window.btoa(profile.getEmail()));
