package com.project.Toshop.security;

import com.project.Toshop.security.JWT.JwtEntryPoint;
import com.project.Toshop.security.JWT.JwtFilter;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/seller/**/delete").access("hasAnyRole('CUSTOMER','EMPLOYEE', 'MANAGER')")
